...
public class Rental {
	...
	public String toString() {
		return "Rental [id=" + id + ", number=" + number + ", payment=" + payment + ", vehicle=" + vehicle
				+ ", businessUnit=" + businessUnit + ", startDate=" + startDate + ", endDate=" + endDate + ", price="
				+ price + ", customer1=" + customer1 + ", customer2=" + customer2 + ", insurancePolicyNumber="
				+ insurancePolicyNumber + ", insuranceCompanyName=" + insuranceCompanyName
				+ ", insuranceExpirationDate=" + insuranceExpirationDate + ", insuranceCompanyContactNumber="
				+ insuranceCompanyContactNumber + ", comments=" + comments + ", insuranceStatus=" + insuranceStatus
				+ ", rentalPaymentId=" + rentalPaymentId + ", additionalDriverCharge=" + additionalDriverCharge
				+ ", replacementVehicle=" + replacementVehicle + ", replacementDate=" + replacementDate
				+ ", extenstion1=" + extenstion1 + ", extenstion1Amount=" + extenstion1Amount + ", extenstion2="
				+ extenstion2 + ", extenstion2Amount=" + extenstion2Amount + "]";
	}
}
